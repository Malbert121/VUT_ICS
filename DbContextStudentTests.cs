...
public class DbContextStudentTests
{
    ...
    public async Task GetAll_Students_HaveSubject()
    {
        ...
        using (var context = new SchoolContext())
        {
            ...
            var student2 = new StudentEntity { firstName = "Andrew", lastName = "Linkoln", fotoURL = "http://www.example.com/index.html" };
            var student3 = new StudentEntity { firstName = "Anna", lastName = "Smith", fotoURL = "http://www.example.com/index.html" };
            var subject1 = new SubjectEntity { name = "Computer Communications and Networks", abbreviation = "IPK" };
    ...
    public async Task GetAll_Activities_OfAStudent()
    {
        ...
        {
            // Arrange
            student = new StudentEntity { firstName = "Peter", lastName = "Adams", fotoURL = "http://www.example.com/index.html" };
            var subject1 = new SubjectEntity { name = "Computer Communications and Networks", abbreviation = "IPK" };
            var subject2 = new SubjectEntity { name = "Database Systems", abbreviation = "IDS" };
    ...
    public async Task GetAll_Subjects_OfAStudent()
    {
        ...
        using (var context = new SchoolContext())
        {
            ...
            var subject1 = new SubjectEntity { name = "Computer Communications and Networks", abbreviation = "IPK" };
            var subject2 = new SubjectEntity { name = "Database Systems", abbreviation = "IDS" };
            var subject3 = new SubjectEntity { name = "Physical Education", abbreviation = "PE" };
