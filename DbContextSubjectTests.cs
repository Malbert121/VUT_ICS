...
public class DbContextSubjectTests
{
    ...
    public async Task AddNew_StudentToSubject_Persisted()
    {
        ...
        using (var context = new SchoolContext())
        {
            var student = new StudentEntity { firstName = "Peter", lastName = "Adams", fotoURL = "http://www.example.com/index.html" };
            var subject = new SubjectEntity { name = "Computer Communications and Networks", abbreviation = "IPK" };
    ...
    public async Task AddNew_ActivityToSubject_Persisted()
    {
        ...
        using (var context = new SchoolContext())
        {
            ...
            var activity = new ActivityEntity { name = "Seminar", subject = subject, subjectId = subjectId, room = "D105", activityTypeTag = "S", description = "Fundamentals seminar" };
    ...
    public async Task GetAll_Students_OfASubject()
    {
        ...
        {
            // Arrange
            subject = new SubjectEntity { name = "Computer Communications and Networks", abbreviation = "IPK" };
            var student1 = new StudentEntity { firstName = "Peter", lastName = "Adams", fotoURL = "http://www.example.com/index.html" };
            var student2 = new StudentEntity { firstName = "Damir", lastName = "Matveev", fotoURL = "http://www.example.com/index.html" };
            var student3 = new StudentEntity { firstName = "Svetlana", lastName = "Eliseeva", fotoURL = "http://www.example.com/index.html" };
    ...
    public async Task GetAll_Activities_OfASubject()
    {
        ...
        {
            // Arrange
            subject1 = new SubjectEntity { name = "Computer Communications and Networks", abbreviation = "IPK" };
            var subject2 = new SubjectEntity { name = "Database Systems", abbreviation = "IDS" };
            var activity1 = new ActivityEntity { name = "Seminar", subject = subject1, subjectId = subject1.subjectId, room = "D0207", activityTypeTag = "S", description = "Fundamentals seminar" };
            var activity2 = new ActivityEntity { name = "Lecture", subject = subject1, subjectId = subject1.subjectId, room = "D105", activityTypeTag = "L", description = "3h lecture" };
            var activity3 = new ActivityEntity { name = "Seminar", subject = subject2, subjectId = subject2.subjectId, room = "D0206", activityTypeTag = "S", description = "Fundamentals seminar" };
