...
public class DbMigrator(IDbContextFactory<SchoolContext> dbContextFactory, DALOptions options)
    : IDbMigrator
{
    ...
    {
        await using SchoolContext dbContext = await dbContextFactory.CreateDbContextAsync(cancellationToken);
